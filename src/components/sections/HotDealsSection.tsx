...
export default function HotDealsSection() {
  ...
  return (
    <section id="hot-deals" className="py-20 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="animate-bounce">
              <Flame className="h-10 w-10 text-primary" />
                          ...
                          <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">
                Hot Deals
              </h2>
        ...
        <div className="relative">
          ...
          >
                      ...
                      <div className="grid md:grid-cols-2 gap-0 min-h-[600px]">
                        ...
                        <div className="p-8 md:p-12 flex flex-col justify-between bg-gradient-to-br from-white to-gray-50 relative overflow-hidden">
                          ...
                          <div className="absolute inset-0 opacity-5">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/50 rounded-full transform translate-x-16 -translate-y-16 group-hover:scale-150 transition-transform duration-1000"></div>
                            <div className="absolute bottom-0 left-0 w-24 h-24 bg-primary/40 rounded-full transform -translate-x-12 translate-y-12 group-hover:scale-150 transition-transform duration-1000 delay-300"></div>
                          </div>
                          ...
                          <div className="relative z-10">
                            ...
                            <div className="mb-6">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-lg font-semibold text-foreground">{deal.rating}</span>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                              <div className="flex items-center text-muted-foreground bg-muted/20 rounded-lg p-3 group-hover:bg-primary/10 transition-colors duration-300">
                          ...
                          <div className="relative z-10">
                            {/* Urgency banner */}
                            <div className="bg-gradient-to-r from-primary/90 to-primary text-white p-3 rounded-lg mb-6 text-center">
                            ...
                            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-6 rounded-xl mb-6 relative overflow-hidden">
                              <div className="absolute top-0 right-0 w-20 h-20 bg-primary/30 rounded-full transform translate-x-10 -translate-y-10 opacity-20"></div>
                              <div className="relative z-10">
                                <div className="flex items-end justify-between">
                                  <div>
                                    <div className="text-sm text-muted line-through mb-1">
                                  ...
                                  <div className="text-right">
                                    ...
                                    <div className="text-sm text-muted">OFF</div>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                              ...
                              <Button 
                                variant="outline" 
                                size="lg" 
                                className="px-6 py-6 border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300 hover:scale-105"
                              >
                                Details
                              </Button>
                            </div>
                        ...
                        <div className="relative h-64 md:h-auto overflow-hidden group">
                          ...
                          <div className="absolute top-0 left-0 w-20 h-20 bg-gradient-to-br from-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <CarouselPrevious className="left-4 bg-white/80 backdrop-blur-sm border-2 border-primary/20 hover:bg-primary/10 hover:border-primary/40 transition-all duration-300" />
            <CarouselNext className="right-4 bg-white/80 backdrop-blur-sm border-2 border-primary/20 hover:bg-primary/10 hover:border-primary/40 transition-all duration-300" />
          </Carousel>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                variant="secondary"
                className="bg-white text-primary hover:bg-gray-100 px-8 py-3 text-lg font-semibold transform hover:scale-105 transition-all duration-300"
              >
                View All Deals
              </Button>
