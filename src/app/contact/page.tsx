...
const faqData = [
  {
    ...
    answer: "You can book a tour through our website, by calling us directly, or by visiting our office. We offer multiple booking options for your convenience."
  },
  {
    question: "What payment methods do you accept?",
    answer: "We accept all major credit cards, PayPal, bank transfers, and cash payments. Payment plans are also available for longer tours."
  },
  {
    question: "Can I cancel or modify my booking?",
    answer: "Yes, you can cancel or modify your booking up to 7 days before departure. Please refer to our cancellation policy for more details."
  },
  {
    question: "Do you provide travel insurance?",
    answer: "Yes, we offer comprehensive travel insurance packages. We highly recommend purchasing insurance for international trips."
  },
  {
    question: "What should I pack for my trip?",
    answer: "Packing requirements vary by destination and season. We'll provide you with a detailed packing list after booking."
  },
  {
    question: "Are meals included in the tour price?",
    answer: "Meal inclusions vary by tour. Some tours include all meals, while others include only breakfast. Check the tour details for specifics."
  }
]
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Ready to explore the world? Contact our travel experts and let us help you plan 
              the perfect journey. We're here to make your travel dreams come true.
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                ...
                <motion.div 
                  className="bg-gray-200 rounded-2xl h-64 mb-6 flex items-center justify-center"
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.3 }}
                >
                  <motion.div 
              ...
              >
                ...
                <motion.p 
                  ...
                  viewport={{ once: true }}
                >
                  Call us now for instant support and personalized travel advice.
                </motion.p>
                <motion.div 
